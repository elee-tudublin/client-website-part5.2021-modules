...
let displayProducts = ((products) => {
    ...
    const rows = products.map(product => {
        ...
        let row = `<tr>
                  ...
                  <td><button id="${product._id}" class="btn btn-sm btn-outline-primary btn-update-product"
                  ...
                  <td><button id="${product._id}" class="btn btn-sm btn-outline-danger btn-delete-product">
